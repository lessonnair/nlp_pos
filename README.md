...
|Refining Word Embeddings for Sentiment Analysis|2017，有监督refine|https://www.aclweb.org/anthology/D17-1056|取一个词的top k个最近的词向量，然后使用对应的极性分数对词进行重排序，并将这个重排序的作用反馈到原向量|
|Refining Word Embeddings Using Intensity Scores for Sentiment Analysis|2018|https://dl.acm.org/purchase.cfm?id=3186455||
|Retrofitting Word Vectors to Semantic Lexicons|2014|https://arxiv.org/abs/1411.4166||
